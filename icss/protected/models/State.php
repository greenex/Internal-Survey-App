...
class State extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('question_group_id, survey_id, user_id', 'required'),
			array('question_group_id, survey_id, user_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, question_group_id, survey_id, user_id', 'safe', 'on'=>'search'),
		);
	}
