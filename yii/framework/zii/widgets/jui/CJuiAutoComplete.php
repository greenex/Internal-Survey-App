...
class CJuiAutoComplete extends CJuiInputWidget
{
	...
	public function run()
	{
		...
		$js = "jQuery('#StockInvoice_medicine').live('focus', function(){
			$(this).autocomplete($options);
		  });jQuery('#StockInvoice_medicine2').live('focus', function(){
			$(this).autocomplete($options);
		  });jQuery('#StockInvoice_medicine3').live('focus', function(){
			$(this).autocomplete($options);
		  });jQuery('#StockInvoice_medicine4').live('focus', function(){
			$(this).autocomplete($options);
		  });jQuery('#StockInvoice_medicine5').live('focus', function(){
			$(this).autocomplete($options);
		  });jQuery('#StockInvoice_medicine6').live('focus', function(){
			$(this).autocomplete($options);
		  });jQuery('#StockInvoice_medicine7').live('focus', function(){
			$(this).autocomplete($options);
		  });jQuery('#StockInvoice_medicine8').live('focus', function(){
			$(this).autocomplete($options);
		  });
		  jQuery('#StockInvoice_n___0_medicine').live('focus', function(){
			$(this).autocomplete($options);
		  });
		  jQuery('#StockInvoice_n___1_medicine').live('focus', function(){
			$(this).autocomplete($options);
		  });
		  jQuery('#StockInvoice_n___2_medicine').live('focus', function(){
			$(this).autocomplete($options);
		  });
		  jQuery('#StockInvoice_n___3_medicine').live('focus', function(){
			$(this).autocomplete($options);
		  });
		  jQuery('#StockInvoice_n___4_medicine').live('focus', function(){
			$(this).autocomplete($options);
		  });
		  jQuery('#StockInvoice_n___5_medicine').live('focus', function(){
			$(this).autocomplete($options);
		  });
		  jQuery('#StockInvoice_n___6_medicine').live('focus', function(){
			$(this).autocomplete($options);
		  });
		  jQuery('#StockInvoice_n___7_medicine').live('focus', function(){
			$(this).autocomplete($options);
		  });";
